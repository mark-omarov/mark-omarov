...
// TODO: Optimize images, remove duplications, extract data (json + rsc + pagination), split components, complete certs, add skeletons on load
// Images can be loaded from local -> https://nextjs.org/docs/app/building-your-application/optimizing/images#local-images
export default function CertificatesPage() {
  const [filter, setFilter] = useState<string>('all');
  const [holopinLoaded, setHolopinLoaded] = useState(false);
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          A collection of certificates I&#39;ve earned throughout my career,
          including exam-based and participation certificates, and badges.
        </p>
      </div>

      <div className="relative mb-8 rounded-lg border">
        {!holopinLoaded && (
          <div style={{ aspectRatio: '2428/764' }} className="w-full">
        ...
        <Image
          ...
          className={`h-auto w-full rounded-lg ${holopinLoaded ? 'visible' : 'invisible absolute'}`}
          onLoadingComplete={() => setHolopinLoaded(true)}
          width={2428}
          height={764}
          priority={false}
        />
